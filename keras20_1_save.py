...
x_train, x_test, y_train, y_test = train_test_split(x, y, random_state=33, train_size=0.9, shuffle=False)
...
model.fit(x_train,y_train, epochs=501, batch_size=1, validation_data=(x_val, y_val))
